package com.sk.recipeapp.bootstrap;

import com.sk.recipeapp.domain.*;
import com.sk.recipeapp.repositories.CategoryRepository;
import com.sk.recipeapp.repositories.RecipeRepository;
import com.sk.recipeapp.repositories.UOMRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipe(){
        ...
        Optional<Category> mexicanCateggoryOptional = categoryRepository.findByDescription("Mexican");
        if(!mexicanCateggoryOptional.isPresent()){
            throw new RuntimeException("Expected Category not found");
        }

        Category americanCategory = americanCategoryOptional.get();
        Category mexicanCategory = mexicanCateggoryOptional.get();

        Recipe guacRecipe = new Recipe();
        guacRecipe.setDescription("Perfect Guacamole");
        guacRecipe.setPerpTime(10);
